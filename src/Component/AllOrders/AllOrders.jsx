...
export default function AllOrders({ userData }) {
  ...
  if (data?.data.data != undefined){
    ...
    return <>
      ...
      </div> : <div id='getOrders' className='d-none'>
      ...
      <div id='noOrders' className='mt-5 container text-center d-none py-2 '>
